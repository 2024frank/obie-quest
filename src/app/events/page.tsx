    ...
    <div className="space-y-8">
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-1 text-gray-800">Oberlin Orchestra Concert</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-1 text-gray-800">Environmental Justice Panel</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-1 text-gray-800">Observatory Open House</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-1 text-gray-800">Fall Break Begins</h3>
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-2 text-gray-800">Departmental Lectures</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-2 text-gray-800">Symposia & Conferences</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-2 text-gray-800">Student Research Presentations</h3>
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-2 text-gray-800">Varsity Athletic Events</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-2 text-gray-800">Club Sports Competitions</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-2 text-gray-800">Intramural Sports</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4 hover:border-red-200 transition-colors">
            <h3 className="font-medium text-lg mb-2 text-gray-800">Fitness Classes</h3>
