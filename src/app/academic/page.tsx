    ...
    <div className="space-y-8">
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Mudd Center</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Conservatory Library</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Science Library</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Art Library</h3>
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-semibold">Study Spaces</h2>
        </div>
        <div className="grid md:grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Wilder Hall</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">King Building</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Science Center</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Residence Hall Common Areas</h3>
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-semibold">Academic Support Services</h2>
        </div>
        <div className="grid md:grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Writing Center</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Quantitative Skills Center</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Peer Tutoring</h3>
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Career Development Center</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Winter Term</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Study Abroad</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">Undergraduate Research</h3>
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-lg mb-2">PRESTO</h3>
